...
def make_slide(ticker):
    try:
        prs = Presentation(save_path + '/etf3.pptx')    # open a pptx file

        if ticker in Equity + Real_Estate + Multi_Asset + Fixed_Income + New:
...
#        text_to_text_placeholder(slide, 2, make_index(soup2))
      ...
      # bottom part of a slide
        ...
        # 4. multiples   
            text_to_text_placeholder(slide, 13, '대/중소형 비율 및 지표(%, x)')
            mp = multiples(soup2)
            mp_fig = mp
            mp_fig_path = save_path + '/mp_fig.png'
            mp_fig.savefig(mp_fig_path, dpi = 'figure', bbox_inches = 'tight')
            chart_to_picture(slide, 14, mp_fig_path)   
        ...
        # 4. credit   
            text_to_text_placeholder(slide, 13, '신용등급')
            cp = credit_analysis(soup2)
            cp_fig = cp
            cp_fig_path = save_path + '/cp_fig.png'
            cp_fig.savefig(cp_fig_path, dpi = 'figure', bbox_inches = 'tight')
            chart_to_picture(slide, 14, cp_fig_path)         
...
Equity_KR_TM = ['A305720', 'A322400', 'A138530', 'A292150', 'A315930', 'A326230', 'A314700', 'A228810', 'A266360',\
                ...
                'A376410', 'A377990', 'A368680', 'A367770', 'A364980', 'A364990', 'A364970', 'A365000', 'A385720']
